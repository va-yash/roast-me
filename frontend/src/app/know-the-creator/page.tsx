...
// 2026-08: was the raw Vercel preview URL for Astra-Pal. See the same
// constant in page.tsx — both surfaces link out, both were pointing at a URL
// that looks like an unfinished deploy.
      ...
      <div style={{ position: "relative", zIndex: 1, minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", padding: "80px 1.5rem 4rem" }}>
        <div style={{ width: "100%", maxWidth: 680 }}>
          ...
          <div style={{ display: "flex", gap: 12, flexWrap: "wrap" }}>
            ...
            {/* 2026-08: X added. layout.tsx already declared twitter:creator
                "@yashrajv", so the handle was being claimed in the page's meta
                tags while no visitor could actually find it. */}
            <a href="https://x.com/yashrajv" target="_blank" rel="noopener noreferrer"
              style={{ display: "inline-flex", alignItems: "center", gap: 8, padding: "10px 20px", borderRadius: 6, fontSize: 13, fontFamily: F.ui, fontWeight: 700, letterSpacing: "0.05em", background: "rgba(255,255,255,0.03)", border: `1px solid ${C.border}`, color: C.muted, textDecoration: "none" }}
              onMouseEnter={e => (e.currentTarget.style.opacity = "0.75")} onMouseLeave={e => (e.currentTarget.style.opacity = "1")}>
